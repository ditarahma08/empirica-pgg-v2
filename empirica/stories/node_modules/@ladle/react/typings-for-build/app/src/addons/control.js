...
const Control = ({ controlKey, globalState, dispatch, }) => {
    ...
    if (globalState.control[controlKey].type === ControlType.Action) {
        return (_jsxs("tr", { children: [_jsx("td", { children: controlKey }), _jsx("td", { children: "action" })] }));
    }
    if (globalState.control[controlKey].type === ControlType.Function) {
        return (_jsxs("tr", { children: [_jsx("td", { children: controlKey }), _jsx("td", { children: "function" })] }));
    }
    if (globalState.control[controlKey].type === ControlType.Radio ||
        globalState.control[controlKey].type === ControlType.InlineRadio) {
        return (_jsxs("tr", { children: [_jsx("td", { children: controlKey }), _jsx("td", { style: globalState.control[controlKey].type === ControlType.InlineRadio
                        ? { display: "flex" }
                        ...
                        return (_jsxs("div", { style: {
                                ...
                                ...(globalState.control[controlKey].type ===
                                    ...
                                    ? { paddingRight: "0.5em" }
                                    : {}),
                            }, children: [_jsx("input", { id: `${controlKey}-${String(option)}`, type: "radio", name: controlKey, value: String(option), onChange: (e) => {
                                        dispatch({
                                    ...
                                    }, checked: isChecked }), _jsx("label", { htmlFor: `${controlKey}-${String(option)}`, children: String(option) })] }, `${String(option)}-${controlKey}`));
                    }) })] }));
    }
    if (globalState.control[controlKey].type === ControlType.Check ||
        ...
        return (_jsxs("tr", { children: [_jsx("td", { children: controlKey }), _jsx("td", { style: globalState.control[controlKey].type === ControlType.InlineCheck
                        ? { display: "flex" }
                        : {}, children: (globalState.control[controlKey].options || []).map((option) => {
                        ...
                        return (_jsxs("div", { style: {
                                ...
                                ...(globalState.control[controlKey].type ===
                                    ...
                                    ? { paddingRight: "0.5em" }
                                    : {}),
                            }, children: [_jsx("input", { id: `${controlKey}-${String(option)}`, type: "checkbox", name: `${controlKey}-${String(option)}`, value: String(option), checked: value.has(String(option)), onChange: (e) => {
                                    ...
                                    } }), _jsx("label", { htmlFor: `${controlKey}-${String(option)}`, style: { marginLeft: "0.3em" }, children: String(option) })] }, `${String(option)}-${controlKey}`));
                    }) })] }));
    }
    if (globalState.control[controlKey].type === ControlType.Select) {
        return (_jsxs("tr", { children: [_jsx("td", { children: _jsx("label", { htmlFor: controlKey, children: controlKey }) }), _jsx("td", { children: _jsxs("select", { id: controlKey, value: String(globalState.control[controlKey].value), onChange: (e) => {
                            dispatch({
                                type: ActionType.UpdateControl,
                                value: {
                                    ...globalState.control,
                        ...
                        }, children: [_jsx("option", { value: "undefined", disabled: true, children: "Choose option..." }), (globalState.control[controlKey].options || []).map((option) => (_jsx("option", { children: String(option) }, `${option}-${controlKey}`)))] }) })] }));
    }
    if (globalState.control[controlKey].type === ControlType.Complex) {
        ...
        return (_jsxs("tr", { children: [_jsx("td", { children: _jsx("label", { htmlFor: controlKey, children: controlKey }) }), _jsx("td", { children: _jsx("textarea", { id: controlKey, defaultValue: stringValue, onChange: (e) => {
    ...
    if (controlState.type === ControlType.Range) {
        ...
        return (_jsxs("tr", { children: [_jsx("td", { children: _jsx("label", { htmlFor: controlKey, children: controlKey }) }), _jsxs("td", { children: [displayMin, _jsx("input", { id: controlKey, type: getInputType(controlState.type), value: controlState.value, min: controlState.min, max: controlState.max, step: controlState.step, onChange: (e) => dispatch({
                                type: ActionType.UpdateControl,
                                value: {
                                    ...globalState.control,
                                    [controlKey]: {
    ...
    return (_jsxs("tr", { children: [_jsx("td", { children: _jsx("label", { htmlFor: controlKey, children: controlKey }) }), _jsx("td", { children: _jsx("input", { id: controlKey, type: getInputType(globalState.control[controlKey].type), value: globalState.control[controlKey].value, checked: globalState.control[controlKey].type === ControlType.Boolean &&
